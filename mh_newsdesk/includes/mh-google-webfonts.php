			...
			if (!empty($mh_newsdesk_fonts['font_size']) && $mh_newsdesk_fonts['font_size'] != 17 || $mh_newsdesk_fonts['font_heading'] != 'oswald' || $mh_newsdesk_fonts['font_body'] != 'pt_serif') {
				echo '<style type="text/css">' . "\n";
					...
					if ($mh_newsdesk_fonts['font_heading'] != 'oswald') {
						echo '.header-nav, .header-sub, h1, h2, h3, h4, h5, h6, .breadcrumb, .footer-bottom, .widget-list li, .cat-item, .page_item, .menu-item, .button, .commentlist .vcard, .pagination, .mh-share-buttons { font-family: ' . $mh_google_webfonts[$mh_newsdesk_fonts['font_heading']]['css'] .'; }' . "\n";
					}
