...
class mh_newsdesk_posts_list extends WP_Widget {
    function __construct() {
		parent::__construct(
			...
			array(
				'classname' => 'mh_newsdesk_posts_list',
				'description' => esc_html__('Display a list of posts on front page for use in "Home 1" or "Home 4" widget areas.', 'mh-newsdesk'),
