...
class Jetty_Widget_Twitter_Feed extends WP_Widget
{
	/**
	...
	public function widget( $args, $instance )
	{
		...
		<div class="twitter-feed-widget" style="overflow:auto;<?php echo $style_h; echo $style_w;?>">
			<a class="twitter-timeline" data-chrome="nofooter" href="//twitter.com/<?php echo $username;?>">Tweets by <?php echo $username;?></a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
		</div>
		<?php
