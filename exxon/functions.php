...
function exxon_customize_slider_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'exxon_lk[0]' );
    ...
    $wp_customize->add_setting('exxon_title_overlay[0]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_title_overlay[0]',
        array(
            'label'         => __( 'Title', 'exxon' ),
            'description'   => __('Title for description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_title_overlay[0]',
            'type'          => 'text',
        ) )
    );
    $wp_customize->add_setting('exxon_desc_overlay[0]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_desc_overlay[0]',
        array(
            'label'      	=> __( 'Description', 'exxon' ),
            'description' 	=> __('This description to show on overlay image','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_desc_overlay[0]',
            'type'       	=> 'textarea',
        ) )
    );
    $wp_customize->add_setting('exxon_link_overlay[0]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_link_overlay[0]',
        array(
            'label'      	=> __( 'Link/Url', 'exxon' ),
            'description' 	=> __('This link for description overlay','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_link_overlay[0]',
            'type'       	=> 'url',
        ) )
    );
    $wp_customize->add_setting('exxon_text_link_overlay[0]', array(
        'default' => 'Read more')
    );
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_text_link_overlay[0]',
        array(
            'label'         => __( 'Text Link', 'exxon' ),
            'description'   => __('Text for link. Example : <b>Read more</b>.','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_text_link_overlay[0]',
            'type'          => 'text'
        ) )
    );

    $wp_customize->add_setting( 'exxon_lk[1]' );
    $wp_customize->add_control( new WP_Customize_Image_Control(
        $wp_customize,
        'exxon_lk[1]',
        array(
    ...
    $wp_customize->add_setting('exxon_title_overlay[1]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_title_overlay[1]',
        array(
            'label'         => __( 'Title', 'exxon' ),
            'description'   => __('Title for description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_title_overlay[1]',
            'type'          => 'text',
        ) )
    );
    $wp_customize->add_setting('exxon_desc_overlay[1]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_desc_overlay[1]',
        array(
            'label'      	=> __( 'Description', 'exxon' ),
            'description' 	=> __('This description to show on overlay image','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_desc_overlay[1]',
            'type'       	=> 'textarea',
        ) )
    );
    $wp_customize->add_setting('exxon_link_overlay[1]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_link_overlay[1]',
        array(
            'label'      	=> __( 'Link/Url', 'exxon' ),
            'description' 	=> __('This link for description overlay','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_link_overlay[1]',
            'type'       	=> 'url',
        ) )
    );
    $wp_customize->add_setting('exxon_text_link_overlay[1]', array()
    );
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_text_link_overlay[1]',
        array(
            'label'         => __( 'Text Link', 'exxon' ),
            'description'   => __('Text for link. Example : <b>Read more</b>.','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_text_link_overlay[1]',
            'type'          => 'text'
        ) )
    );

    $wp_customize->add_setting( 'exxon_lk[2]' );
    $wp_customize->add_control( new WP_Customize_Image_Control(
        $wp_customize,
        'exxon_lk[2]',
        array(
    ...
    $wp_customize->add_setting('exxon_title_overlay[2]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_title_overlay[2]',
        array(
            'label'         => __( 'Title', 'exxon' ),
            'description'   => __('Title for description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_title_overlay[2]',
            'type'          => 'text',
        ) )
    );
    $wp_customize->add_setting('exxon_desc_overlay[2]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_desc_overlay[2]',
        array(
            'label'      	=> __( 'Description', 'exxon' ),
            'description' 	=> __('This description to show on overlay image','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_desc_overlay[2]',
            'type'       	=> 'textarea',
        ) )
    );
    $wp_customize->add_setting('exxon_link_overlay[2]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_link_overlay[2]',
        array(
            'label'      	=> __( 'Link/Url', 'exxon' ),
            'description' 	=> __('This link for description overlay','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_link_overlay[2]',
            'type'       	=> 'url',
        ) )
    );
    $wp_customize->add_setting('exxon_text_link_overlay[2]', array(
        'default' => 'Read more')
    );
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_text_link_overlay[2]',
        array(
            'label'         => __( 'Text Link', 'exxon' ),
            'description'   => __('Text for link. Example : <b>Read more</b>.','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_text_link_overlay[2]',
            'type'          => 'text'
        ) )
    );

    $wp_customize->add_setting( 'exxon_lk[3]' );
    $wp_customize->add_control( new WP_Customize_Image_Control(
        $wp_customize,
        'exxon_lk[3]',
        array(
    ...
    $wp_customize->add_setting('exxon_title_overlay[3]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_title_overlay[3]',
        array(
            'label'         => __( 'Title', 'exxon' ),
            'description'   => __('Title for description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_title_overlay[3]',
            'type'          => 'text',
        ) )
    );
    $wp_customize->add_setting('exxon_desc_overlay[3]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_desc_overlay[3]',
        array(
            'label'      	=> __( 'Description', 'exxon' ),
            'description' 	=> __('This description to show on overlay image','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_desc_overlay[3]',
            'type'       	=> 'textarea',
        ) )
    );
    $wp_customize->add_setting('exxon_link_overlay[3]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_link_overlay[3]',
        array(
            'label'      	=> __( 'Link/Url', 'exxon' ),
            'description' 	=> __('This link for description overlay','exxon'),
            'section'   	=> 'add_lgs',
            'settings'   	=> 'exxon_link_overlay[3]',
            'type'       	=> 'url',
        ) )
    );
    $wp_customize->add_setting('exxon_text_link_overlay[3]', array(
        'default' => 'Read more')
    );
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_text_link_overlay[3]',
        array(
            'label'         => __( 'Text Link', 'exxon' ),
            'description'   => __('Text for link. Example : <b>Read more</b>.','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_text_link_overlay[3]',
            'type'          => 'text'
        ) )
    );

    $wp_customize->add_setting( 'exxon_lk[4]' );
    $wp_customize->add_control( new WP_Customize_Image_Control(
        $wp_customize,
        'exxon_lk[4]',
        array(
    ...
    $wp_customize->add_setting('exxon_title_overlay[4]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_title_overlay[4]',
        array(
            'label'         => __( 'Title', 'exxon' ),
            'description'   => __('Title for description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_title_overlay[4]',
            'type'          => 'text',
        ) )
    );
    $wp_customize->add_setting('exxon_desc_overlay[4]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_desc_overlay[4]',
        array(
            'label'         => __( 'Description', 'exxon' ),
            'description'   => __('This description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_desc_overlay[4]',
            'type'          => 'textarea',
        ) )
    );
    $wp_customize->add_setting('exxon_link_overlay[4]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_link_overlay[4]',
        array(
            'label'         => __( 'Link/Url', 'exxon' ),
            'description'   => __('This link for description overlay','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_link_overlay[4]',
            'type'          => 'url',
        ) )
    );
    $wp_customize->add_setting('exxon_text_link_overlay[4]', array(
        'default' => 'Read more')
    );
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_text_link_overlay[4]',
        array(
            'label'         => __( 'Text Link', 'exxon' ),
            'description'   => __('Text for link. Example : <b>Read more</b>.','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_text_link_overlay[4]',
            'type'          => 'text'
        ) )
    );

    $wp_customize->add_setting( 'exxon_lk[5]' );
    $wp_customize->add_control( new WP_Customize_Image_Control(
        $wp_customize,
        'exxon_lk[5]',
        array(
    ...
    $wp_customize->add_setting('exxon_title_overlay[5]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_title_overlay[5]',
        array(
            'label'         => __( 'Title', 'exxon' ),
            'description'   => __('Title for description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_title_overlay[5]',
            'type'          => 'text',
        ) )
    );
    $wp_customize->add_setting('exxon_desc_overlay[5]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_desc_overlay[5]',
        array(
            'label'         => __( 'Description', 'exxon' ),
            'description'   => __('This description to show on overlay image','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_desc_overlay[5]',
            'type'          => 'textarea',
        ) )
    );
    $wp_customize->add_setting('exxon_link_overlay[5]');
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_link_overlay[5]',
        array(
            'label'         => __( 'Link/Url', 'exxon' ),
            'description'   => __('This link for description overlay','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_link_overlay[5]',
            'type'          => 'url',
        ) )
    );
    $wp_customize->add_setting('exxon_text_link_overlay[5]', array(
        'default' => 'Read more')
    );
    $wp_customize->add_control(
        new WP_Customize_Control(
        $wp_customize,
        'exxon_text_link_overlay[5]',
        array(
            'label'         => __( 'Text Link', 'exxon' ),
            'description'   => __('Text for link. Example : <b>Read more</b>.','exxon'),
            'section'       => 'add_lgs',
            'settings'      => 'exxon_text_link_overlay[5]',
            'type'          => 'text'
        ) )
    );
...
if(!function_exists('exxon_child_register_script')):
	function exxon_child_register_script(){
        ...
        // Redundantly load style-sheet as this is the only method to cache-bust
        // Aweful, I know, but the WordPress "Version" comment does not work
        wp_enqueue_style( 'exxon-theme-style', trailingslashit(get_stylesheet_directory_uri()) . 'style.css', [], $version );
		...
		wp_enqueue_script( 'custom-child-script', trailingslashit(get_stylesheet_directory_uri()) . 'js/script.js', array(), $version, true);
...
add_action( 'widgets_init', 'exxon_frontpage_widgets_init' );
