	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title" id="cobalt-telephone-page-title"><?php _e('Telephone Numbers', 'cobalt'); ?></h1>
				<?php
			...
			while ( have_posts() ) : the_post();
				 ...
				 */
				get_template_part( 'template-parts/content', 'telephone' );
			endwhile;
        ...
        <div class="row pagination-container" id="cobalt-pagination-telephone">
