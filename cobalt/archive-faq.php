	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title" id="cobalt-faq-page-title"><?php _e('FAQs', 'cobalt'); ?></h1>
		...
		<?php
            ...
            if ( 1 == $total ) {
              _e( '<p class="showing_count">Showing the single result</p>', 'cobalt' );
                ...
                printf( __( '<p class="showing_count">Showing all %d results</p>', 'cobalt' ), $total );
              } else {
        ...
        ?>
			<?php
				...
				echo '<p class="archive-description">';
        ...
        <div class="row pagination-container" id="cobalt-pagination-faq">
