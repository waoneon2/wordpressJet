...
<div id="page-wrapper-first" class="hfeed sites page-tmp2">
    ...
    <div class="top-bar">
        <div class="row">
            ...
            $link_url = esc_url('//corporate.exxonmobil.com');
            $link_logo = "fa-globe";

            if(get_theme_mod('exxon_external_link_text')){
                $link_text = get_theme_mod('exxon_external_link_text');
            }
            if(get_theme_mod('exxon_external_link_url')){
                $link_url = esc_url(get_theme_mod('exxon_external_link_url'));
            }
            if(get_theme_mod('exxon_external_link_logo')){
                $link_logo = get_theme_mod('exxon_external_link_logo');
            }
            ?>
            <a href="<?php echo $link_url; ?>" target="_blank">
            <span class="divider"></span>
            <i class="fa <?php echo $link_logo; ?>" id="logo-external-link"></i>
            <span class="select-country"><?php echo $link_text; ?></span>
            </a>
            </div>
        </div>
    </div>
    ...
    <nav id="main-nav" class="navbar navbar-default">
        <div class="container-fluid no-padding">
            ...
            <a class="navbar-brand" href="<?php echo ($_uri = jetty_header_custom_url()) ? $_uri : home_url(); ?>">
    ...
    <article>
        ...
        <?php if(is_front_page()) :?>
            <div id="home-slideshow" class="row">
                ...
                ?>
                    <div id="slideshow-photos" class="cycle-slideshow" data-cycle-fx="fade" data-cycle-timeout="3000" data-cycle-auto-height="calc" data-cycle-pause-on-hover=true data-cycle-log=false>
