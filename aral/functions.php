<?php
/**
 * aral functions and definitions.
 *
...
function aral_setup() {
	 ...
	 * If you're building a theme based on aral, use a find and replace
	 * to change 'aral' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'aral', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'aral' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'aral_custom_background_args', array(
...
add_action( 'after_setup_theme', 'aral_content_width', 0 );
 ...
 */
function aral_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'aral' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'aral_widgets_init' );
...
function aral_scripts() {
	...
	wp_enqueue_style( 'aral-style', get_stylesheet_uri() );

	wp_enqueue_style( 'grid-style', get_template_directory_uri() . '/css/grid.css' );

	wp_enqueue_script( 'aral-navigation', get_template_directory_uri() . '/js/navigation.js', array('jquery'), '20120206', true );

	wp_enqueue_script( 'aral-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
...
add_action('after_setup_theme', 'aral_remove_formats', 100);
function aral_remove_formats()
{
