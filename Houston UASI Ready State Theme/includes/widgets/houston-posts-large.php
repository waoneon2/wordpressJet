...
/***** Houston UASI Posts Large (Homepage) *****/

class houston_uasi_posts_large extends WP_Widget {
    function __construct() {
		parent::__construct(
			'houston_uasi_posts_large', esc_html_x('Houston UASI Posts Large (Homepage)', 'widget name', 'houston-uasi'),
			array(
				'classname' => 'houston_uasi_posts_large',
				'description' => esc_html__('Display posts with large images on front page for use in "Home 1" or "Home 4" widget areas.', 'houston-uasi'),
