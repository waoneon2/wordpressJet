...
/***** Houston UASI Posts List (Homepage) *****/

class houston_uasi_posts_list extends WP_Widget {
    function __construct() {
		parent::__construct(
			'houston_uasi_posts_list', esc_html_x('Houston UASI Posts List (Homepage)', 'widget name', 'houston-uasi'),
			array(
				'classname' => 'houston_uasi_posts_list',
				'description' => esc_html__('Display a list of posts on front page for use in "Home 1" or "Home 4" widget areas.', 'houston-uasi'),
    ...
    function widget($args, $instance) {
        ...
        echo $before_widget;
			...
			<div class="houston-fp-list-widget clearfix"><?php
