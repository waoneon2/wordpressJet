...
/***** Houston UASI Recent Comments *****/

class houston_uasi_comments extends WP_Widget {
    function __construct() {
		parent::__construct(
			'houston_uasi_comments', esc_html_x('Houston UASI Recent Comments', 'widget name', 'houston-uasi'),
			array(
				'classname' => 'houston_uasi_comments',
				'description' => esc_html__('Houston UASI Recent Comments widget to display your recent comments including user avatars.', 'houston-uasi'),
	   			...
	   			if ($comments) {
	   				foreach ($comments as $comment) { ?>
	   					<li class="uw-wrap clearfix">
			   				...
			   				<div class="uw-text">
				   				<?php printf(_x('%1$s on %2$s', 'comment widget', 'houston-uasi'), $comment->comment_author, ''); ?>
    ...
    function form($instance) {
        $defaults = array('title' => esc_html__('Recent Comments', 'houston-uasi'), 'number' => '5', 'offset' => '0');
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Limit Comment Number:', 'houston-uasi'); ?></label>
	    ...
	    <p>
        	<label for="<?php echo $this->get_field_id('offset'); ?>"><?php _e('Skip Comments (Offset):', 'houston-uasi'); ?></label>
