...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
    	<p class="category">
             <span class="author"><?php $categories = get_the_category(); if($categories[0]->cat_ID != 532 &&  $categories[0]->cat_ID != 504) { ?>By <?php the_author_posts_link(); ?> on <?php echo get_the_date(); ?><?php } else { ?> <?php echo get_the_date(); ?><?php }?></span>   
        </p> 
		<?php if ( has_post_thumbnail() && ! post_password_required() && ! is_single( 196 ) ) : ?>
...
<li class="item-one bullet">
    <h1><a href="<?php the_permalink(); ?>"><i><?php if($publicationName = get_field('publication_name')) : ?> <?php echo $publicationName . ','; endif; ?></i> <?php echo get_the_date(); ?></i></a>, <a href="<?php the_permalink(); ?>" class="blue-link"><?php the_title(); ?></a>
    </h1>
</li>
