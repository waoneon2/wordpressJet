...
function sth_scripts() {
	...
	wp_enqueue_style( 'sth-orange-css', get_template_directory_uri() . '/inc/blue.css' );
...
function defaultAssetsImage($name_of_section){
	if(empty($name_of_section)){
		...
		switch ($name_of_section) {
			case 'content-main':
				$cm_assets = get_template_directory_uri() . '/images/sth_image/body_hero.png';
				return $cm_assets;
				break;

			case 'feature-one':
				$fo = array(
					1 => get_template_directory_uri() . '/images/sth_image/clock24.png',
					2 => get_template_directory_uri() . '/images/sth_image/customize.png',
					3 => get_template_directory_uri() . '/images/sth_image/money.png'
				);
				return $fo;
				break;

			case 'feature-two-image':
				$fti = get_template_directory_uri() . '/images/sth_image/responsive_template.png';
				return $fti;
				break;

			case 'feature-two':
				$ft = array(
					1  => get_template_directory_uri() . '/images/sth_image/tie.png',
					2  => get_template_directory_uri() . '/images/sth_image/email.png',
					3  => get_template_directory_uri() . '/images/sth_image/chartline.png',
					4  => get_template_directory_uri() . '/images/sth_image/controlpanel.png',
					5  => get_template_directory_uri() . '/images/sth_image/cog.png',
					6  => get_template_directory_uri() . '/images/sth_image/wallet.png',
					7  => get_template_directory_uri() . '/images/sth_image/target.png',
					8  => get_template_directory_uri() . '/images/sth_image/chartcolumn.png',
					9  => get_template_directory_uri() . '/images/sth_image/talogo.png'
				);
				return $ft;
				break;

			case 'demo-ribbon-bg':
				$drb = get_template_directory_uri() . '/images/sth_image/cta_mid_bgnd.jpg';
				return $drb;
				break;

			case 'demo-ribbon-icon':
				$dri = get_template_directory_uri() . '/images/sth_image/suitcase.png';
				return $dri;
				break;

			case 'signup-ribbon-bg':
				$srb = get_template_directory_uri() . '/images/sth_image/cta_bottom_bgnd.jpg';
				return $srb;
				break;

			case 'how-it-work-profile':
				$srb = get_template_directory_uri() . '/images/sth_image/chad.jpg';
				return $srb;
				break;

			case 'signup-ribbon-icon':
				$sri = get_template_directory_uri() . '/images/sth_image/pen_blue.png';
				return $sri;
				break;

			case 'footer-setting':
				$fl = get_template_directory_uri() . '/images/sth_image/footer_logo.png';
				return $fl;
				break;
...
function sth_create_default_menu(){
	$menu_name = "Stay to Help Menu";
	...
	if(!$menu_exists){
	    ...
	    wp_update_nav_menu_item($menu_id, 0, array(
	        ...
	        'menu-item-classes' => 'howitworks',
	        'menu-item-url' => '#how_it_works',
	        'menu-item-type' => 'custom',
	        'menu-item-status' => 'publish'));
	    wp_update_nav_menu_item($menu_id, 0, array(
	        'menu-item-title' =>  __('Sign up'),
	        'menu-item-classes' => 'signup',
	        'menu-item-url' => '#call_to_action_bottom',
	        'menu-item-type' => 'custom',
	        'menu-item-status' => 'publish'));
	    wp_update_nav_menu_item($menu_id, 0, array(
	        ...
	        'menu-item-status' => 'publish'));
	    wp_update_nav_menu_item($menu_id, 0, array(
	        'menu-item-title' =>  __('Make a booking'),
	        'menu-item-classes' => 'makeabooking',
	        'menu-item-url' => esc_url('https://reservations.staytohelp.com/'),
	        'menu-item-type' => 'custom',
	        'menu-item-status' => 'publish'));
	    wp_update_nav_menu_item($menu_id, 0, array(
	        'menu-item-title' =>  __('Site Administration'),
	        'menu-item-classes' => 'siteadministration',
	        'menu-item-url' => esc_url('https://my.staytohelp.com/admin'),
	        'menu-item-type' => 'custom',
	        'menu-item-status' => 'publish'));
