...
class sth_walker_nav_menu extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $object, $depth = 0, $args = array(), $current_object_id = 0) {
        ...
        if(!empty(parse_url($object->url)['fragment']) || isset(parse_url($object->url)['fragment'])){
            $attributes .= 'data-click="scroll-to-target"';
        }
