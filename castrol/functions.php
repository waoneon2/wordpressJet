<?php
/**
 * castrol functions and definitions.
 *
...
if ( ! function_exists( 'castrol_setup' ) ) :
/**
 ...
 */
function castrol_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on castrol, use a find and replace
	 * to change 'castrol' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'castrol', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'castrol' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'castrol_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'castrol_setup' );
 ...
 */
function castrol_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'castrol_content_width', 640 );
}
add_action( 'after_setup_theme', 'castrol_content_width', 0 );
 ...
 */
function castrol_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'castrol' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'castrol_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function castrol_scripts() {
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.css' );

	wp_enqueue_style( 'castrol-style', get_stylesheet_uri() );

	wp_enqueue_style( 'grid-style', get_template_directory_uri() . '/css/grid.css' );

	wp_enqueue_script( 'castrol-navigation', get_template_directory_uri() . '/js/navigation.js', array('jquery'), '20120206', true );

	wp_enqueue_script( 'castrol-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'castrol_scripts' );
    ...
    if ( !is_front_page() ) {
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            echo '<li class="item-current item-current-' . get_search_query() . '"></li>';
                printf( esc_html__( 'Search Results for: %s', 'castrol' ), '<span class="bread-current bread-current-' . get_search_query() . '" title="Search results for: ' . get_search_query() . '">' . get_search_query() . '</span>');
...
add_action('after_setup_theme', 'castrol_remove_formats', 100);
function castrol_remove_formats()
{
