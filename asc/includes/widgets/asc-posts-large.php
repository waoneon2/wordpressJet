...
/***** ASC Posts Large (Homepage) *****/

class asc_posts_large extends WP_Widget {
    function __construct() {
		parent::__construct(
			'asc_posts_large', esc_html_x('ASC Posts Large (Homepage)', 'widget name', 'asc'),
			array(
				'classname' => 'asc_posts_large',
				'description' => esc_html__('Display posts with large images on front page for use in "Home 1" or "Home 4" widget areas.', 'asc'),
