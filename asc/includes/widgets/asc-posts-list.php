...
/***** ASC Posts List (Homepage) *****/

class asc_posts_list extends WP_Widget {
    function __construct() {
		parent::__construct(
			'asc_posts_list', esc_html_x('ASC Posts List (Homepage)', 'widget name', 'asc'),
			array(
				'classname' => 'asc_posts_list',
				'description' => esc_html__('Display a list of posts on front page for use in "Home 1" or "Home 4" widget areas.', 'asc'),
    ...
    function widget($args, $instance) {
        ...
        echo $before_widget;
			...
			<div class="asc-fp-list-widget clearfix"><?php
