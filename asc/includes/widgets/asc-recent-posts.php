...
class asc_recent_posts extends WP_Widget {
    function __construct() {
		parent::__construct(
			'asc_recent_posts', esc_html_x('ASC Recent Posts', 'widget name', 'asc'),
			array(
				'classname' => 'asc_recent_posts',
				'description' => esc_html__('Display a list of most recent posts.', 'asc'),
    ...
    function widget($args, $instance) {
        ...
        echo $before_widget;
			...
			<ul class="asc-rp-widget widget-list"><?php
