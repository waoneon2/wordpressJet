<div class="social-media-area">
    <div class="tab-content ui-tabs ui-widget ui-widget-content ui-corner-all">
         <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
             <li class="ui-state-default ui-corner-top active"><a data-toggle="tab" href="#tabs-mobile-1"><span class="fa fa-facebook-square fa-3x" data-mce-mark="1"></span></a></li>
             <li class="ui-state-default ui-corner-top"><a data-toggle="tab" href="#tabs-mobile-2"><span class="fa fa-twitter-square fa-3x" data-mce-mark="1"></span></a></li>
             <li class="ui-state-default ui-corner-top"><a data-toggle="tab" href="#tabs-mobile-3"><span class="fa fa-youtube-square fa-3x" data-mce-mark="1"></span></a></li>
         </ul>
        ...
        <!-- Facebook -->
        <div id="tabs-mobile-1" class="pierFacebook tab-pane ui-corner-bottom in active">
            <div class="scroll250">
                <div id="fb-root"></div>
        ...
        <!-- Twitter -->
        <div id="tabs-mobile-2" class="pierTwitter tab-pane ui-corner-bottom ">
        ...
        <!-- Youtube -->
        <div id="tabs-mobile-3" class="pierYoutube scroll360 tab-pane ui-corner-bottom ">
