...
function jas_get_search_form() {
	$value['s'] = isset($_GET['s']) ? $_GET['s'] : '';
	
	if(isset($_GET['post_date'])):
	$post_date = explode(' ', $_GET['post_date']);
	endif;
	$value['f_sd'] = isset($post_date[0]) ? $post_date[0] : '';
	$value['f_ed'] = isset($post_date[1]) ? $post_date[1] : '';
    ...
    <div>
        <div class="form-group clearfix">
            ...
            <div class="col-md-7 col-sm-8 col-xs-8">
                <input class="form-control " type="text" name="search" placeholder="" value="'.$value['s'].'" required>
            </div>
        ...
        <div class="form-group clearfix">
            ...
            <div class="col-md-3 col-sm-8 col-xs-8">
                <input class="form-control postform" type="text" name="post_date[]" id="f_sd" value="'.$value['f_sd'].'">
            </div>
            <div class="col-md-2">
        ...
        <div class="form-group clearfix">
            ...
            <div class="col-md-3 col-sm-8 col-xs-8">
                <input class="form-control postform" type="text" name="post_date[]" id="f_ed" value="'.$value['f_ed'].'">
            </div>
            <div class="col-md-2">
