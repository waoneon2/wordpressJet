				...
				if(error == ''){
					$.each(a, function(i,item){
						if(i < n){
							...
							if(type == 'twitter'){
								intro_top += '<div class="on_section_intro">'+icon+'<span class="section-share" id="share-on-top">'+s+'</span></div>';
							} else {
								intro_top += '<div class="on_section_intro">'+icon+'<span class="section-share other-twitter" id="share-on-top">'+s+'</span></div>';
							}
							var inquiry = '<div class="on_inquiry"><button class="btn_on_inquiry" type="button"><p class="text_inquiry">Create Inquiry</p></button></div>';
							...
							var out = '<li rel="'+ob+'" class="dcsns-li dcsns-'+type+' dcsns-feed-'+fn+'">'+w+intro_top+'<div class="inner">'+zz+'<span class="clear"></span></div>'+zintro+icon+inquiry+'</li>', str = decodeURIComponent(opt.remove), rem = q;
							if(type == 'twitter'){
