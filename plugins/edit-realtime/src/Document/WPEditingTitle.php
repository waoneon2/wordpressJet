...
class WPEditingTitle implements DocumentBackend
{
    ...
    public function get($id)
    {
        ...
        return $editing->post_title;
    }

    public function deleteOperations($id)
    {
        update_post_meta($id, '_jte_text_title_operations', []);
        update_post_meta($id, '_jte_text_title_last_operations', []);
    }

    public function saveOperation($userid, $id, TextOperation $operation)
    {
        $operations = get_post_meta($id, '_jte_text_title_operations', true);
        $lastOperation = get_post_meta($id, '_jte_text_title_last_operations', true);
        ...
        update_post_meta($id, '_jte_text_title_operations', $operations);
        update_post_meta($id, '_jte_text_title_last_operations', $lastOperation);
    }
